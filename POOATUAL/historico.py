...
class historico(object):
    """
    A classe historico é responsável por apresentar as informações do usuario

    Essa classe realiza o fornecimento das informações dos sintomas recorrentes do usuario. Cada sintoma que foi definido é apresentado aqui. 
    """
...
"background-color: rgb(192, 97, 203);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p>Histórico</p></body></html>"))
